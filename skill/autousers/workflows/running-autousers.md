...
`autousers_run` SPENDS Gemini tokens (real money) once queued. The cost band is **~$0.105 per rating** (URL stimulus, SSE) to **~$0.158 per rating** (URL stimulus, SxS). One rating = one autouser × one comparison.
